namespace WordleServer.Data
{
    public static class WordList
    {
        public static string GetWordOfTheDay()
        {
            ...
            int seed = today.Year * 1000 + today.DayOfYear; // unique seed for every day
            Random random = new Random(seed);

            int index = random.Next(WordsOfTheDay.Length);

            return WordsOfTheDay[index];
        }
        
        private static readonly string[] WordsOfTheDay = new string[]
        {
